const ViewProducts = () => {
  return (
    <div>
      <nav class="block w-full px-4 py-2 mx-auto text-white bg-white border shadow-md rounded-xl border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
        <div class="container flex items-center justify-between mx-auto text-blue-gray-900">
          ...
          <div class="flex items-center gap-x-1">
            <button
              class=" px-4 py-2 font-sans text-xs font-bold text-center text-gray-900 uppercase align-middle transition-all rounded-lg select-none hover:bg-gray-900/10 active:bg-gray-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block"
              type="button"
            >
              <span>Log In</span>
            </button>
        ...
        <div style={{ display: "flex", width: "100%", flexWrap: "wrap" }}>
          <div style={{ width: "20%", padding: "5px" }}>
            ...
            >
              ...
              <div>
                <img src="https://static5.lenskart.com/media/catalog/product/pro/1/thumbnail/628x301/9df78eab33525d08d6e5fb8d27136e95//v/i/silver-black-brown-full-rim-rectangle-square-vincent-chase-online-the-metal-edit-vc-s12593-p-c3-polarized-sunglasses_csvfile-1687346139589-g_2549.jpg" />
              </div>
              ...
              <div style={{ paddingRight: "10px", paddingLeft: "10px" }}>
                ...
                <div style={{ color: "#333368" }}>Size : Wide</div>
                <div>$1500</div>
              </div>
              <div
                style={{
                  background: "linear-gradient(45deg, #E0C67C, #F7F1DE)",
                  height: "100%",
                  padding: "10px",
